...
Project by **Saptarshi Das** (Roll No. 20246704, MS Quantum Technology).
...
## How It Works
1. The robot continuously moves forward (patrolling mode).
2. Three flame sensors monitor for fire:
   - **Front detection**: Stops, centers nozzle, activates pump and sweeps servo for wide spray.
...
Upload using the Arduino IDE. No external libraries required beyond the standard `Servo.h`.
...
- Larger water reservoir or fan fallback option

## License
MIT License – feel free to fork, modify, and build your own!

---
Built as an educational Arduino robotics project. For questions or contributions, open an issue.
